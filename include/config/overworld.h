...
#define OW_SEASON_DISABLE_FALLBACK      TRUE        // If TRUE, if the encounter table for a specific season is empty, the area will have no encounters instead of falling back to the vanilla season and time.
