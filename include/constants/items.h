...
enum __attribute__((packed)) Item
{
    ...
    ITEM_POKEVIAL = 874,
    ITEM_OUTFIT_BOX = 875,
    ITEM_RULEKEEPER_BLESSING = 876,
    ITEM_CLOCKCHANGER_BLESSING = 877,
    ITEM_WINDSEEKER_BLESSING = 878,
    ITEM_FLAMESTEALER_BLESSING = 879,
    ITEM_VOIDWALKER_BLESSING = 880,
    ITEM_CLAYMAKER_BLESSING = 881,
    ITEM_WAVEBRINGER_BLESSING = 882,
    ITEM_OATHBREAKER_BLESSING = 883,
