...
#define SCR_OP_QUESTMENU 0xe6
#define SCR_OP_TOGGLEOUTFIT 0xe9
#define SCR_OP_GETOUTFITSTATUS 0xea
#define SCR_OP_BUFFEROUTFITSTR 0xeb
#define SCR_OP_POKEMARTOUTFIT 0xec
#define SCR_OP_HIDEFOLLOWER 0xed
