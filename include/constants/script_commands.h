...
enum ScrOp
{
    ...
    SCR_OP_QUESTMENU = 0xE6,
    SCR_OP_SUBQUESTMENU = 0xE7,
    SCR_OP_RETURNQUESTSTATE = 0xE8,
    SCR_OP_TOGGLEOUTFIT = 0xE9,
    SCR_OP_GETOUTFITSTATUS = 0xEA,
    SCR_OP_BUFFEROUTFITSTR = 0xEB,
    SCR_OP_POKEMARTOUTFIT = 0xEC,
    SCR_OP_HIDEFOLLOWER = 0xED,
    SCR_OP_GETBRAILLESTRINGWIDTH = 0xEE,
};
