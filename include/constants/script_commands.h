...
#define SCR_OP_SETSPEAKER 0xe5
#define SCR_OP_QUESTMENU 0xe7
#define SCR_OP_TOGGLEOUTFIT 0xea
#define SCR_OP_GETOUTFITSTATUS 0xeb
#define SCR_OP_BUFFEROUTFITSTR 0xec
#define SCR_OP_POKEMARTOUTFIT 0xed
#define SCR_OP_HIDEFOLLOWER 0xee
