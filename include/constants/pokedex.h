...
// Kingsisle Regional Dex
enum KingsisleDexOrder {
    KINGSISLE_DEX_NONE,
    KINGSISLE_DEX_SNIVY,
    KINGSISLE_DEX_SERVINE,
    KINGSISLE_DEX_SERPERIOR,
    KINGSISLE_DEX_FENNEKIN,
    KINGSISLE_DEX_BRAIXEN,
    KINGSISLE_DEX_DELPHOX,
    KINGSISLE_DEX_PIPLUP,
    KINGSISLE_DEX_PRINPLUP,
    KINGSISLE_DEX_EMPOLEON,
    KINGSISLE_DEX_PIDOVE,
    KINGSISLE_DEX_TRANQUILL,
    KINGSISLE_DEX_UNFEZANT,
    KINGSISLE_DEX_WURMPLE,
    KINGSISLE_DEX_SILCOON,
    KINGSISLE_DEX_BEAUTIFLY,
    KINGSISLE_DEX_CASCOON,
    KINGSISLE_DEX_DUSTOX,
    KINGSISLE_DEX_SHINX,
    KINGSISLE_DEX_LUXIO,
    KINGSISLE_DEX_LUXRAY,
    KINGSISLE_DEX_MINCCINO,
    KINGSISLE_DEX_CINCCINO,
    KINGSISLE_DEX_AZURILL,
    KINGSISLE_DEX_MARILL,
    KINGSISLE_DEX_AZUMARILL,
    KINGSISLE_DEX_SINISTEA,
    KINGSISLE_DEX_POLTEAGEIST,
    KINGSISLE_DEX_TRUBBISH,
    KINGSISLE_DEX_GARBODOR,
    KINGSISLE_DEX_MEOWTH,
    KINGSISLE_DEX_PERSIAN,
    // NATURE PRESERVE POKEMON
    KINGSISLE_DEX_BUIZEL,
    KINGSISLE_DEX_FLOATZEL,
    KINGSISLE_DEX_PACHIRISU,
    KINGSISLE_DEX_ESPURR,
    KINGSISLE_DEX_MEOWSTIC,
    KINGSISLE_DEX_ABRA,
    KINGSISLE_DEX_KADABRA,
    KINGSISLE_DEX_ALAKAZAM,
    KINGSISLE_DEX_ROGGENROLA,
    KINGSISLE_DEX_BOLDORE,
    KINGSISLE_DEX_GIGALITH,
    KINGSISLE_DEX_SANDSHREW,
    KINGSISLE_DEX_SANDSLASH,
    KINGSISLE_DEX_WOOBAT,
    KINGSISLE_DEX_SWOOBAT,

    //
    KINGSISLE_DEX_DITTO = 98,
    KINGSISLE_DEX_MEW = 99,
    KINGSISLE_DEX_MEWTWO = 100
};

#define KINGSISLE_DEX_COUNT (KINGSISLE_DEX_MEWTWO + 1)
...
#define DAWNSINGER_DEX_COUNT (UNDERGROUND_DEX_SWOOBAT - UNDERGROUND_DEX_SHIFTRY)
