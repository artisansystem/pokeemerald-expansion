...
enum DawnsingerDexOrder {
    ...
    //
    DAWNSINGER_DEX_DITTO = 98,
    DAWNSINGER_DEX_MEW = 99,
    DAWNSINGER_DEX_MEWTWO = 100
};
...
#define LOCKWOOD_DEX_COUNT (UNDERGROUND_DEX_SHIFTRY + 1)
#define DAWNSINGER_DEX_COUNT (DAWNSINGER_DEX_MEWTWO + 1)
#define SUMMERSPELL_DEX_COUNT (UNDERGROUND_DEX_STOUTLAND - UNDERGROUND_DEX_SWOOBAT)
#define WILLOWBLOOM_DEX_COUNT (UNDERGROUND_DEX_SWAMPERT - UNDERGROUND_DEX_STOUTLAND)
#define TITANBLAZE_DEX_COUNT (UNDERGROUND_DEX_FERALIGATR - UNDERGROUND_DEX_SWAMPERT)
#define ROSESONG_DEX_COUNT (UNDERGROUND_DEX_PRIMARINA - UNDERGROUND_DEX_FERALIGATR)
#define WISEMORE_DEX_COUNT (UNDERGROUND_DEX_INTELEON - UNDERGROUND_DEX_PRIMARINA)
#define AUBERON_DEX_COUNT (UNDERGROUND_DEX_GRENINJA - UNDERGROUND_DEX_INTELEON)
...
enum
{
    DEX_MODE_DAWNSINGER,
    DEX_MODE_WISEMORE,
    DEX_MODE_SUMMERSPELL,
    DEX_MODE_TITANBLAZE,
    DEX_MODE_WILLOWBLOOM,
    DEX_MODE_AUBERON,
    DEX_MODE_ROSESONG,
    DEX_MODE_LOCKWOOD,
