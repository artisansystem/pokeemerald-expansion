...
#define LOCKWOOD_DEX_COUNT (UNDERGROUND_DEX_SAMUROTT + 1)
#define DAWNSINGER_DEX_COUNT (UNDERGROUND_DEX_LUXRAY - UNDERGROUND_DEX_SAMUROTT)
#define SUMMERSPELL_DEX_COUNT (UNDERGROUND_DEX_BLASTOISE - UNDERGROUND_DEX_LUXRAY)
#define WILLOWBLOOM_DEX_COUNT (UNDERGROUND_DEX_SWAMPERT - UNDERGROUND_DEX_BLASTOISE)
