...
// Dawnsinger Regional Dex
enum DawnsingerDexOrder {

    // STARTERS
    DAWNSINGER_DEX_NONE,
    DAWNSINGER_DEX_SNIVY,
    DAWNSINGER_DEX_SERVINE,
    DAWNSINGER_DEX_SERPERIOR,
    DAWNSINGER_DEX_FENNEKIN,
    DAWNSINGER_DEX_BRAIXEN,
    DAWNSINGER_DEX_DELPHOX,
    DAWNSINGER_DEX_PIPLUP,
    DAWNSINGER_DEX_PRINPLUP,
    DAWNSINGER_DEX_EMPOLEON,

    // FAIRGROUNDS/GENERAL
    DAWNSINGER_DEX_PIDOVE,
    DAWNSINGER_DEX_TRANQUILL,
    DAWNSINGER_DEX_UNFEZANT,
    DAWNSINGER_DEX_WURMPLE,
    DAWNSINGER_DEX_SILCOON,
    DAWNSINGER_DEX_BEAUTIFLY,
    DAWNSINGER_DEX_CASCOON,
    DAWNSINGER_DEX_DUSTOX,
    DAWNSINGER_DEX_SHINX,
    DAWNSINGER_DEX_LUXIO,
    DAWNSINGER_DEX_LUXRAY,
    DAWNSINGER_DEX_MINCCINO,
    DAWNSINGER_DEX_CINCCINO,
    DAWNSINGER_DEX_TRUBBISH,
    DAWNSINGER_DEX_GARBODOR,
    DAWNSINGER_DEX_MEOWTH,
    DAWNSINGER_DEX_PERSIAN,

    // WITHERBLOOM
    DAWNSINGER_DEX_LEDYBA,
    DAWNSINGER_DEX_LEDIAN,
    DAWNSINGER_DEX_SENTRET,
    DAWNSINGER_DEX_FURRET,
    DAWNSINGER_DEX_HOOTHOOT,
    DAWNSINGER_DEX_NOCTOWL,
    DAWNSINGER_DEX_EEVEE,
    DAWNSINGER_DEX_ESPEON,
    DAWNSINGER_DEX_UMBREON,
    DAWNSINGER_DEX_SYLVEON,
    DAWNSINGER_DEX_DEERLING,
    DAWNSINGER_DEX_SAWSBUCK,
    DAWNSINGER_DEX_SHROOMISH,
    DAWNSINGER_DEX_BRELOOM,
    DAWNSINGER_DEX_SNOVER,
    DAWNSINGER_DEX_ABOMASNOW,
    DAWNSINGER_DEX_PETILIL,
    DAWNSINGER_DEX_LILLIGANT,
    DAWNSINGER_DEX_CHERUBI,
    DAWNSINGER_DEX_CHERRIM,
    DAWNSINGER_DEX_MAGIKARP,
    DAWNSINGER_DEX_GYARADOS,
    DAWNSINGER_DEX_FEEBAS,
    DAWNSINGER_DEX_MILOTIC,
    DAWNSINGER_DEX_GOLDEEN,
    DAWNSINGER_DEX_SEAKING,
    DAWNSINGER_DEX_STARYU,
    DAWNSINGER_DEX_STARMIE,
    DAWNSINGER_DEX_TENTACOOL,
    DAWNSINGER_DEX_TENTACRUEL,
    DAWNSINGER_DEX_ELGYEM,
    DAWNSINGER_DEX_BEHEEYEM,
    DAWNSINGER_DEX_MUNNA,
    DAWNSINGER_DEX_MUSHARNA,
    DAWNSINGER_DEX_CLEFFA,
    DAWNSINGER_DEX_CLEFAIRY,
    DAWNSINGER_DEX_CLEFABLE,
    DAWNSINGER_DEX_GOTHITA,
    DAWNSINGER_DEX_GOTHORITA,
    DAWNSINGER_DEX_GOTHITELLE,
    DAWNSINGER_DEX_MINIOR,

    //LOREHOLD
    DAWNSINGER_DEX_ROGGENROLA,
    DAWNSINGER_DEX_BOLDORE,
    DAWNSINGER_DEX_GIGALITH,
    DAWNSINGER_DEX_SANDSHREW,
    DAWNSINGER_DEX_SANDSLASH,
    DAWNSINGER_DEX_WOOBAT,
    DAWNSINGER_DEX_SWOOBAT,
    DAWNSINGER_DEX_NACLI,
    DAWNSINGER_DEX_NACLSTACK,
    DAWNSINGER_DEX_GARGANACL,
    DAWNSINGER_DEX_BALTOY,
    DAWNSINGER_DEX_CLAYDOL,
    DAWNSINGER_DEX_GEODUDE,
    DAWNSINGER_DEX_GRAVELER,
    DAWNSINGER_DEX_GOLEM,
    DAWNSINGER_DEX_DWEBBLE,
    DAWNSINGER_DEX_CRUSTLE,
    DAWNSINGER_DEX_CARBINK,
    DAWNSINGER_DEX_HONEDGE,
    DAWNSINGER_DEX_DOUBLADE,
    DAWNSINGER_DEX_AEGISLASH,
    DAWNSINGER_DEX_PAWNIARD,
    DAWNSINGER_DEX_BISHARP,
    DAWNSINGER_DEX_KINGAMBIT,
    DAWNSINGER_DEX_YAMASK,
    DAWNSINGER_DEX_COFAGRIGUS,
    DAWNSINGER_DEX_RUNERIGUS,
    DAWNSINGER_DEX_BRONZOR,
    DAWNSINGER_DEX_BRONZONG,
    DAWNSINGER_DEX_CHINGLING,
    DAWNSINGER_DEX_CHIMECHO,
    DAWNSINGER_DEX_OMANYTE,
    DAWNSINGER_DEX_OMASTAR,
    DAWNSINGER_DEX_KABUTO,
    DAWNSINGER_DEX_KABUTOPS,

    // SILVERQUILL
    DAWNSINGER_DEX_LITWICK,
    DAWNSINGER_DEX_LAMPENT,
    DAWNSINGER_DEX_CHANDELURE,
    DAWNSINGER_DEX_SINISTEA,
    DAWNSINGER_DEX_POLTEAGEIST,
    DAWNSINGER_DEX_HATTENA,
    DAWNSINGER_DEX_HATTREM,
    DAWNSINGER_DEX_HATTERENE,
    DAWNSINGER_DEX_SOLOSIS,
    DAWNSINGER_DEX_DUOSION,
    DAWNSINGER_DEX_REUNICLUS,
    DAWNSINGER_DEX_KLEFKI,

    // PRISMARI
    DAWNSINGER_DEX_SHROODLE,
    DAWNSINGER_DEX_GRAFAIAI,
    DAWNSINGER_DEX_SMEARGLE,
    DAWNSINGER_DEX_SPRITZEE,
    DAWNSINGER_DEX_AROMATISSE,
    DAWNSINGER_DEX_FLABEBE,
    DAWNSINGER_DEX_FLOETTE,
    DAWNSINGER_DEX_FLORGES,
    DAWNSINGER_DEX_SKITTY,
    DAWNSINGER_DEX_DELCATTY,

    // QUANDRIX
    DAWNSINGER_DEX_HAPPINY,
    DAWNSINGER_DEX_CHANSEY,
    DAWNSINGER_DEX_BLISSEY,
    DAWNSINGER_DEX_ELEKID,
    DAWNSINGER_DEX_ELECTABUZZ,
    DAWNSINGER_DEX_ELECTIVIRE,
    DAWNSINGER_DEX_MAGBY,
    DAWNSINGER_DEX_MAGMAR,
    DAWNSINGER_DEX_MAGMORTAR,
    DAWNSINGER_DEX_SMOOCHUM,
    DAWNSINGER_DEX_JYNX,
    DAWNSINGER_DEX_MUNCHLAX,
    DAWNSINGER_DEX_SNORLAX,
    DAWNSINGER_DEX_AZURILL,
    DAWNSINGER_DEX_MARILL,
    DAWNSINGER_DEX_AZUMARILL,
    DAWNSINGER_DEX_GASTLY,
    DAWNSINGER_DEX_HAUNTER,
    DAWNSINGER_DEX_GENGAR,
    DAWNSINGER_DEX_SHUPPET,
    DAWNSINGER_DEX_BANETTE,
    DAWNSINGER_DEX_MISDREAVUS,
    DAWNSINGER_DEX_MISMAGIUS,
    DAWNSINGER_DEX_SABLEYE,

    // CYBERMEND
    DAWNSINGER_DEX_VOLTORB,
    DAWNSINGER_DEX_ELECTRODE,
    DAWNSINGER_DEX_KLINK,
    DAWNSINGER_DEX_KLANG,
    DAWNSINGER_DEX_KLINKLANG,
    DAWNSINGER_DEX_JOLTIK,
    DAWNSINGER_DEX_GALVANTULA,
    DAWNSINGER_DEX_TIMBURR,
    DAWNSINGER_DEX_GURDURR,
    DAWNSINGER_DEX_CONKELDURR,
    DAWNSINGER_DEX_PORYGON,
    DAWNSINGER_DEX_PORYGON2,
    DAWNSINGER_DEX_PORYGON_Z,

    // ROUTE POKEMON
    DAWNSINGER_DEX_BUIZEL,
    DAWNSINGER_DEX_FLOATZEL,
    DAWNSINGER_DEX_PACHIRISU,
    DAWNSINGER_DEX_ESPURR,
    DAWNSINGER_DEX_MEOWSTIC,
    DAWNSINGER_DEX_ABRA,
    DAWNSINGER_DEX_KADABRA,
    DAWNSINGER_DEX_ALAKAZAM,

    // ERSIM SECT 
    DAWNSINGER_DEX_ZUBAT,
    DAWNSINGER_DEX_GOLBAT,
    DAWNSINGER_DEX_CROBAT,
    DAWNSINGER_DEX_MACHOP,
    DAWNSINGER_DEX_MACHOKE,
    DAWNSINGER_DEX_MACHAMP,
    DAWNSINGER_DEX_NOSEPASS,
    DAWNSINGER_DEX_PROBOPASS,
    DAWNSINGER_DEX_ARON,
    DAWNSINGER_DEX_LAIRON,
    DAWNSINGER_DEX_AGGRON,
    DAWNSINGER_DEX_ROLYCOLY,
    DAWNSINGER_DEX_CARKOAL,
    DAWNSINGER_DEX_COALOSSAL,
    DAWNSINGER_DEX_WOOLOO,
    DAWNSINGER_DEX_DUBWOOL,
    DAWNSINGER_DEX_CUFANT,
    DAWNSINGER_DEX_COPPERAJAH,
    DAWNSINGER_DEX_MAKUHITA,
    DAWNSINGER_DEX_HARIYAMA,
    DAWNSINGER_DEX_MEDITITE,
    DAWNSINGER_DEX_MEDICHAM,
    DAWNSINGER_DEX_TINKATINK,
    DAWNSINGER_DEX_TINKATUFF,
    DAWNSINGER_DEX_TINKATON,
    DAWNSINGER_DEX_LECHONK,
    DAWNSINGER_DEX_OINKOLOGNE,

    // LOCAL LEGENDS
    DAWNSINGER_DEX_DITTO,
    DAWNSINGER_DEX_ROTOM,
    DAWNSINGER_DEX_MEW,
    DAWNSINGER_DEX_MEWTWO,
};

#define DAWNSINGER_DEX_COUNT (DAWNSINGER_DEX_MEWTWO + 1)

// Underground Complete Dex
enum UndergroundDexOrder {
    UNDERGROUND_DEX_NONE,

    // Chaos Sector's Pokemon
    UNDERGROUND_DEX_TURTWIG,
    UNDERGROUND_DEX_GROTLE,
    UNDERGROUND_DEX_TORTERRA,
    UNDERGROUND_DEX_LITTEN,
    UNDERGROUND_DEX_TORRACAT,
    UNDERGROUND_DEX_INCINEROAR,
    UNDERGROUND_DEX_OSHAWOTT,
    UNDERGROUND_DEX_DEWOTT,
    UNDERGROUND_DEX_SAMUROTT,
    UNDERGROUND_DEX_STARLY,
    UNDERGROUND_DEX_STARAVIA,
    UNDERGROUND_DEX_STARAPTOR,
    UNDERGROUND_DEX_NYMBLE,
    UNDERGROUND_DEX_LOKIX,
    UNDERGROUND_DEX_NIDORAN_M,
    UNDERGROUND_DEX_NIDORINO,
    UNDERGROUND_DEX_NIDOKING,
    UNDERGROUND_DEX_SEEDOT,
    UNDERGROUND_DEX_NUZLEAF,
    UNDERGROUND_DEX_SHIFTRY,
    
    // Dawnsinger Sector's Pokemon
    UNDERGROUND_DEX_SNIVY,
    UNDERGROUND_DEX_SERVINE,
    UNDERGROUND_DEX_SERPERIOR,
    UNDERGROUND_DEX_FENNEKIN,
    UNDERGROUND_DEX_BRAIXEN,
    UNDERGROUND_DEX_DELPHOX,
    UNDRGROUND_DEX_PIPLUP,
    UNDERGROUND_DEX_PRINPLUP,
    UNDERGROUND_DEX_EMPOLEON,
    UNDERGROUND_DEX_PIDOVE,
    UNDERGROUND_DEX_TRANQUILL,
    UNDERGROUND_DEX_UNFEZANT,
    UNDERGROUND_DEX_WURMPLE,
    UNDERGROUND_DEX_SILCOON,
    UNDERGROUND_DEX_BEAUTIFLY,
    UNDERGROUND_DEX_CASCOON,
    UNDERGROUND_DEX_DUSTOX,
    UNDERGROUND_DEX_SHINX,
    UNDERGROUND_DEX_LUXIO,
    UNDERGROUND_DEX_LUXRAY,
    UNDERGROUND_DEX_MINCCINO,
    UNDERGROUND_DEX_CINCCINO,
    UNDERGROUND_DEX_TRUBBISH,
    UNDERGROUND_DEX_GARBODOR,
    UNDERGROUND_DEX_MEOWTH,
    UNDERGROUND_DEX_PERSIAN,
    UNDERGROUND_DEX_LEDYBA,
    UNDERGROUND_DEX_LEDIAN,
    UNDERGROUND_DEX_SENTRET,
    UNDERGROUND_DEX_FURRET,
    UNDERGROUND_DEX_HOOTHOOT,
    UNDERGROUND_DEX_NOCTOWL,
    UNDERGROUND_DEX_EEVEE,
    UNDERGROUND_DEX_ESPEON,
    UNDERGROUND_DEX_UMBREON,
    UNDERGROUND_DEX_SYLVEON,
    UNDERGROUND_DEX_DEERLING,
    UNDERGROUND_DEX_SAWSBUCK,
    UNDERGROUND_DEX_SHROOMISH,
    UNDERGROUND_DEX_BRELOOM,
    UNDERGROUND_DEX_SNOVER,
    UNDERGROUND_DEX_ABOMASNOW,
    UNDERGROUND_DEX_PETILIL,
    UNDERGROUND_DEX_LILLIGANT,
    UNDERGROUND_DEX_CHERUBI,
    UNDERGROUND_DEX_CHERRIM,
    UNDERGROUND_DEX_MAGIKARP,
    UNDERGROUND_DEX_GYARADOS,
    UNDERGROUND_DEX_FEEBAS,
    UNDERGROUND_DEX_MILOTIC,
    UNDERGROUND_DEX_GOLDEEN,
    UNDERGROUND_DEX_SEAKING,
    UNDERGROUND_DEX_STARYU,
    UNDERGROUND_DEX_STARMIE,
    UNDERGROUND_DEX_TENTACOOL,
    UNDERGROUND_DEX_TENTACRUEL,
    UNDERGROUND_DEX_ELGYEM,
    UNDERGROUND_DEX_BEHEEYEM,
    UNDERGROUND_DEX_MUNNA,
    UNDERGROUND_DEX_MUSHARNA,
    UNDERGROUND_DEX_CLEFFA,
    UNDERGROUND_DEX_CLEFAIRY,
    UNDERGROUND_DEX_CLEFABLE,
    UNDERGROUND_DEX_GOTHITA,
    UNDERGROUND_DEX_GOTHORITA,
    UNDERGROUND_DEX_GOTHITELLE,
    UNDERGROUND_DEX_MINIOR,
    UNDERGROUND_DEX_ROGGENROLA,
    UNDERGROUND_DEX_BOLDORE,
    UNDERGROUND_DEX_GIGALITH,
    UNDERGROUND_DEX_SANDSHREW,
    UNDERGROUND_DEX_SANDSLASH,
    UNDERGROUND_DEX_WOOBAT,
    UNDERGROUND_DEX_SWOOBAT,
    UNDERGROUND_DEX_NACLI,
    UNDERGROUND_DEX_NACLSTACK,
    UNDERGROUND_DEX_GARGANACL,
    UNDERGROUND_DEX_BALTOY,
    UNDERGROUND_DEX_CLAYDOL,
    UNDERGROUND_DEX_GEODUDE,
    UNDERGROUND_DEX_GRAVELER,
    UNDERGROUND_DEX_GOLEM,
    UNDERGROUND_DEX_DWEBBLE,
    UNDERGROUND_DEX_CRUSTLE,
    UNDERGROUND_DEX_CARBINK,
    UNDERGROUND_DEX_HONEDGE,
    UNDERGROUND_DEX_DOUBLADE,
    UNDERGROUND_DEX_AEGISLASH,
    UNDERGROUND_DEX_PAWNIARD,
    UNDERGROUND_DEX_BISHARP,
    UNDERGROUND_DEX_KINGAMBIT,
    UNDERGROUND_DEX_YAMASK,
    UNDERGROUND_DEX_COFAGRIGUS,
    UNDERGROUND_DEX_RUNERIGUS,
    UNDERGROUND_DEX_BRONZOR,
    UNDERGROUND_DEX_BRONZONG,
    UNDERGROUND_DEX_CHINGLING,
    UNDERGROUND_DEX_CHIMECHO,
    UNDERGROUND_DEX_OMANYTE,
    UNDERGROUND_DEX_OMASTAR,
    UNDERGROUND_DEX_KABUTO,
    UNDERGROUND_DEX_KABUTOPS,
    UNDERGROUND_DEX_LITWICK,
    UNDERGROUND_DEX_LAMPENT,
    UNDERGROUND_DEX_CHANDELURE,
    UNDERGROUND_DEX_SINISTEA,
    UNDERGROUND_DEX_POLTEAGEIST,
    UNDERGROUND_DEX_HATTENA,
    UNDERGROUND_DEX_HATTREM,
    UNDERGROUND_DEX_HATTERENE,
    UNDERGROUND_DEX_SOLOSIS,
    UNDERGROUND_DEX_DUOSION,
    UNDERGROUND_DEX_REUNICLUS,
    UNDERGROUND_DEX_KLEFKI,
    UNDERGROUND_DEX_SHROODLE,
    UNDERGROUND_DEX_GRAFAIAI,
    UNDERGROUND_DEX_SMEARGLE,
    UNDERGROUND_DEX_SPRITZEE,
    UNDERGROUND_DEX_AROMATISSE,
    UNDERGROUND_DEX_FLABEBE,
    UNDERGROUND_DEX_FLOETTE,
    UNDERGROUND_DEX_FLORGES,
    UNDERGROUND_DEX_SKITTY,
    UNDERGROUND_DEX_DELCATTY,
    UNDERGROUND_DEX_HAPPINY,
    UNDERGROUND_DEX_CHANSEY,
    UNDERGROUND_DEX_BLISSEY,
    UNDERGROUND_DEX_ELEKID,
    UNDERGROUND_DEX_ELECTABUZZ,
    UNDERGROUND_DEX_ELECTIVIRE,
    UNDERGROUND_DEX_MAGBY,
    UNDERGROUND_DEX_MAGMAR,
    UNDERGROUND_DEX_MAGMORTAR,
    UNDERGROUND_DEX_SMOOCHUM,
    UNDERGROUND_DEX_JYNX,
    UNDERGROUND_DEX_MUNCHLAX,
    UNDERGROUND_DEX_SNORLAX,
    UNDERGROUND_DEX_AZURILL,
    UNDERGROUND_DEX_MARILL,
    UNDERGROUND_DEX_AZUMARILL,
    UNDERGROUND_DEX_GASTLY,
    UNDERGROUND_DEX_HAUNTER,
    UNDERGROUND_DEX_GENGAR,
    UNDERGROUND_DEX_SHUPPET,
    UNDERGROUND_DEX_BANETTE,
    UNDERGROUND_DEX_MISDREAVUS,
    UNDERGROUND_DEX_MISMAGIUS,
    UNDERGROUND_DEX_SABLEYE,
    UNDERGROUND_DEX_VOLTORB,
    UNDERGROUND_DEX_ELECTRODE,
    UNDERGROUND_DEX_KLINK,
    UNDERGROUND_DEX_KLANG,
    UNDERGROUND_DEX_KLINKLANG,
    UNDERGROUND_DEX_JOLTIK,
    UNDERGROUND_DEX_GALVANTULA,
    UNDERGROUND_DEX_TIMBURR,
    UNDERGROUND_DEX_GURDURR,
    UNDERGROUND_DEX_CONKELDURR,
    UNDERGROUND_DEX_PORYGON,
    UNDERGROUND_DEX_PORYGON2,
    UNDERGROUND_DEX_PORYGON_Z,
    UNDERGROUND_DEX_BUIZEL,
    UNDERGROUND_DEX_FLOATZEL,
    UNDERGROUND_DEX_PACHIRISU,
    UNDERGROUND_DEX_ESPURR,
    UNDERGROUND_DEX_MEOWSTIC,
    UNDERGROUND_DEX_ABRA,
    UNDERGROUND_DEX_KADABRA,
    UNDERGROUND_DEX_ALAKAZAM,
    UNDERGROUND_DEX_ZUBAT,
    UNDERGROUND_DEX_GOLBAT,
    UNDERGROUND_DEX_CROBAT,
    UNDERGROUND_DEX_MACHOP,
    UNDERGROUND_DEX_MACHOKE,
    UNDERGROUND_DEX_MACHAMP,
    UNDERGROUND_DEX_NOSEPASS,
    UNDERGROUND_DEX_PROBOPASS,
    UNDERGROUND_DEX_ARON,
    UNDERGROUND_DEX_LAIRON,
    UNDERGROUND_DEX_AGGRON,
    UNDERGROUND_DEX_ROLYCOLY,
    UNDERGROUND_DEX_CARKOAL,
    UNDERGROUND_DEX_COALOSSAL,
    UNDERGROUND_DEX_WOOLOO,
    UNDERGROUND_DEX_DUBWOOL,
    UNDERGROUND_DEX_CUFANT,
    UNDERGROUND_DEX_COPPERAJAH,
    UNDERGROUND_DEX_MAKUHITA,
    UNDERGROUND_DEX_HARIYAMA,
    UNDERGROUND_DEX_MEDITITE,
    UNDERGROUND_DEX_MEDICHAM,
    UNDERGROUND_DEX_TINKATINK,
    UNDERGROUND_DEX_TINKATUFF,
    UNDERGROUND_DEX_TINKATON,
    UNDERGROUND_DEX_LECHONK,
    UNDERGROUND_DEX_OINKOLOGNE,
    UNDERGROUND_DEX_DITTO,
    UNDERGROUND_DEX_ROTOM,
    UNDERGROUND_DEX_MEW,
    UNDERGROUND_DEX_MEWTWO,

    // Summerspell Sector's Pokemon
    UNDERGROUND_DEX_TREECKO,
    UNDERGROUND_DEX_GROVYLE,
    UNDERGROUND_DEX_SCEPTILE,
    UNDERGROUND_DEX_FUECOCO,
    UNDERGROUND_DEX_CROCALOR,
    UNDERGROUND_DEX_SKELEDIRGE,
    UNDERGROUND_DEX_SQUIRTLE,
    UNDERGROUND_DEX_WARTORTLE,
    UNDERGROUND_DEX_BLASTOISE,
    UNDERGROUND_DEX_PIDGEY,
    UNDERGROUND_DEX_PIDGEOTTO,
    UNDERGROUND_DEX_PIDGEOT,
    UNDERGROUND_DEX_WEEDLE,
    UNDERGROUND_DEX_KAKUNA,
    UNDERGROUND_DEX_BEEDRILL,
    UNDERGROUND_DEX_SMOLIV,
    UNDERGROUND_DEX_DOLLIV,
    UNDERGROUND_DEX_ARBOLIVA,
    UNDERGROUND_DEX_LILLIPUP,
    UNDERGROUND_DEX_HERDIER,
    UNDERGROUND_DEX_STOUTLAND,

    // Willowbloom Sector's Pokemon
    UNDERGROUND_DEX_BULBASAUR,
    UNDERGROUND_DEX_IVYSAUR,
    UNDERGROUND_DEX_VENUSAUR,
    UNDERGROUND_DEX_SCORBUNNY,
    UNDERGROUND_DEX_RABOOT,
    UNDERGROUND_DEX_CINDERACE,
    UNDERGROUND_DEX_MUDKIP,
    UNDERGROUND_DEX_MARSHTOMP,
    UNDERGROUND_DEX_SWAMPERT,

    // Titanblaze Sector's Pokemon
    UNDERGROUND_DEX_CHESPIN,
    UNDERGROUND_DEX_QUILLADIN,
    UNDERGROUND_DEX_CHESNAUGHT,
    UNDERGROUND_DEX_TORCHIC,
    UNDERGROUND_DEX_COMBUSKEN,
    UNDERGROUND_DEX_BLAZIKEN,
    UNDERGROUND_DEX_TOTODILE,
    UNDERGROUND_DEX_CROCONAW,
    UNDERGROUND_DEX_FERALIGATR,

    // Rosesong Sector's Pokemon
    UNDERGROUND_DEX_GROOKEY,
    UNDERGROUND_DEX_THWACKEY,
    UNDERGROUND_DEX_RILLABOOM,
    UNDERGROUND_DEX_TEPIG,
    UNDERGROUND_DEX_PIGNITE,
    UNDERGROUND_DEX_EMBOAR,
    UNDERGROUND_DEX_POPPLIO,
    UNDERGROUND_DEX_BRIONNE,
    UNDERGROUND_DEX_PRIMARINA,

    // Wisemore Sector's Pokemon
    UNDERGROUND_DEX_ROWLET,
    UNDERGROUND_DEX_DARTRIX,
    UNDERGROUND_DEX_DECIDUEYE,
    UNDERGROUND_DEX_CYNDAQUIL,
    UNDERGROUND_DEX_QUILAVA,
    UNDERGROUND_DEX_TYPHLOSION,
    UNDERGROUND_DEX_SOBBLE,
    UNDERGROUND_DEX_DRIZZILE,
    UNDERGROUND_DEX_INTELEON,

    // Auberon Sector's Pokemon
    UNDERGROUND_DEX_SPRIGATITO,
    UNDERGROUND_DEX_FLORAGATO,
    UNDERGROUND_DEX_MEOWSCARADA,
    UNDERGROUND_DEX_CHIMCHAR,
    UNDERGROUND_DEX_MONFERNO,
    UNDERGROUND_DEX_INFERNAPE,
    UNDERGROUND_DEX_FROAKIE,
    UNDERGROUND_DEX_FROGADIER,
    UNDERGROUND_DEX_GRENINJA,

    // Mythical Pokemon
    UNDERGROUND_DEX_SILVALLY = 600,
};

#define UNDERGROUND_DEX_COUNT (UNDERGROUND_DEX_SILVALLY + 1)

// enum NationalDexOrder {
    
//     NATIONAL_DEX_NONE,

//     Human World Starters
//     NATIONAL_DEX_CHIKORITA,
//     NATIONAL_DEX_BAYLEEF,
//     NATIONAL_DEX_MEGANIUM,
//     NATIONAL_DEX_CHARMANDER,
...
//     // Mythical Pokemon
//     NATIONAL_DEX_SILVALLY = 600,

//     // Legendaries
//     NATIONAL_DEX_DIALGA = 697,
//     NATIONAL_DEX_PALKIA = 698,
//     NATIONAL_DEX_GIRATINA = 699,
//     NATIONAL_DEX_ARCEUS = 700
// };

// #define NATIONAL_DEX_COUNT (NATIONAL_DEX_ARCEUS + 1)
