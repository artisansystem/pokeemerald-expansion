...
#define FOREACH_SPECIES_IN_DAWNSINGER_DEX_ORDER(F) \
    F(SNIVY) \
    F(SERVINE) \
    F(SERPERIOR) \
    F(FENNEKIN) \
...
enum DawnsingerDexOrder {
    DAWNSINGER_DEX_NONE,
    #define DAWNSINGER_DEX_ENUM(name) DAWNSINGER_DEX_ ##name,
    FOREACH_SPECIES_IN_DAWNSINGER_DEX_ORDER(DAWNSINGER_DEX_ENUM)
    #undef DAWNSINGER_DEX_ENUM
};
   
#define DAWNSINGER_DEX_COUNT (DAWNSINGER_DEX_MEWTWO + 1)

#define FOREACH_SPECIES_IN_UNDERGROUND_DEX_ORDER(F) \
    F(TURTWIG) \
    F(GROTLE) \
    F(TORTERRA) \
    F(LITTEN) \
...
enum UndergroundDexOrder {
    ...
    #define UNDERGROUND_DEX_ENUM(name) UNDERGROUND_DEX_ ##name,
    FOREACH_SPECIES_IN_UNDERGROUND_DEX_ORDER(UNDERGROUND_DEX_ENUM)
    #undef UNDERGROUND_DEX_ENUM
};
