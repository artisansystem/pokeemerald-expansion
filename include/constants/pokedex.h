...
#define DAWNSINGER_DEX_COUNT (UNDERGROUND_DEX_LUXRAY - UNDERGROUND_DEX_SHIFTRY)
#define SUMMERSPELL_DEX_COUNT (UNDERGROUND_DEX_STOUTLAND - UNDERGROUND_DEX_LUXRAY)
