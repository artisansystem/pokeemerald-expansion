...
enum UndergroundDexOrder {
    ...
    // Legendaries
    UNDERGROUND_DEX_DIALGA = 597,
    UNDERGROUND_DEX_PALKIA = 598,
    UNDERGROUND_DEX_GIRATINA = 599,
    UNDERGROUND_DEX_ARCEUS = 600
};

#define LOCKWOOD_DEX_COUNT (UNDERGROUND_DEX_SAMUROTT)
...
#define UNDERGROUND_DEX_COUNT (UNDERGROUND_DEX_ARCEUS + 1)
