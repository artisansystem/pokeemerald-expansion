...
extern const u32 gBattleEnvironmentTiles_GrassyPlains[];
extern const u32 gBattleEnvironmentTilemap_GrassyPlains[];
extern const u16 gBattleEnvironmentPalette_GrassyPlains[];
