...
const struct Outfit gOutfits[OUTFIT_COUNT] =
{
    ...
    [OUTFIT_USUAL_GREEN] = {
        ...
        .trainerPics = {
            [MALE] = {
                [APPEARANCE_LIGHT] =   { TRAINER_PIC_FRONT_BRENDAN, TRAINER_PIC_BACK_BRENDAN, },
                [APPEARANCE_OLIVE] =   { TRAINER_PIC_FRONT_BRENDAN, TRAINER_PIC_BACK_BRENDAN, },
                [APPEARANCE_BROWN] =   { TRAINER_PIC_FRONT_BRENDAN, TRAINER_PIC_BACK_BRENDAN, },
                [APPEARANCE_DARK] =   { TRAINER_PIC_FRONT_BRENDAN, TRAINER_PIC_BACK_BRENDAN, },
            },
            [FEMALE] = {
                [APPEARANCE_LIGHT] = { TRAINER_PIC_FRONT_MAY, TRAINER_PIC_BACK_MAY, },
                [APPEARANCE_OLIVE] = { TRAINER_PIC_FRONT_MAY, TRAINER_PIC_BACK_MAY, },
                [APPEARANCE_BROWN] = { TRAINER_PIC_FRONT_MAY, TRAINER_PIC_BACK_MAY, },
                [APPEARANCE_DARK] = { TRAINER_PIC_FRONT_MAY, TRAINER_PIC_BACK_MAY, },
            }, 
            [NONBINARY] = {
                [APPEARANCE_LIGHT] = {TRAINER_PIC_FRONT_WALLY, TRAINER_PIC_BACK_WALLY, },
                [APPEARANCE_OLIVE] = {TRAINER_PIC_FRONT_WALLY, TRAINER_PIC_BACK_WALLY, },
                [APPEARANCE_BROWN] = {TRAINER_PIC_FRONT_WALLY, TRAINER_PIC_BACK_WALLY, },
                [APPEARANCE_DARK] = {TRAINER_PIC_FRONT_WALLY, TRAINER_PIC_BACK_WALLY, },
            }        
        },
        ...
        .avatarGfxIds = {
           ...
           [NONBINARY] = {
                [APPEARANCE_LIGHT] = {
                    ...
                    [PLAYER_AVATAR_STATE_MACH_BIKE] = OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_ACRO_BIKE] =  OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_SURFING] =    OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_UNDERWATER] = OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_FIELD_MOVE] = OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_FISHING] =    OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_WATERING] =   OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_VSSEEKER] =   OBJ_EVENT_GFX_WALLY
                },
                [APPEARANCE_OLIVE] = {
                    [PLAYER_AVATAR_STATE_NORMAL] =     OBJ_EVENT_GFX_WALLY,
                    [PLAYER_AVATAR_STATE_MACH_BIKE] = OBJ_EVENT_GFX_WALLY,
