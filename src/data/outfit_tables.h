...
const struct Outfit gOutfits[OUTFIT_COUNT] =
{
    ...
    [OUTFIT_USUAL_GREEN] = {
        ...
        .trainerPics = {
            [MALE] = {
                [APPEARANCE_LIGHT] = TRAINER_PIC_BRENDAN,
                [APPEARANCE_OLIVE] = TRAINER_PIC_BRENDAN,
                [APPEARANCE_BROWN] = TRAINER_PIC_BRENDAN,
                [APPEARANCE_DARK] = TRAINER_PIC_BRENDAN, 
            },
            [FEMALE] = {
                [APPEARANCE_LIGHT] = TRAINER_PIC_MAY,
                [APPEARANCE_OLIVE] = TRAINER_PIC_MAY,
                [APPEARANCE_BROWN] = TRAINER_PIC_MAY,
                [APPEARANCE_DARK] = TRAINER_PIC_MAY,
            }, 
            [NONBINARY] = {
                [APPEARANCE_LIGHT] = TRAINER_PIC_WALLY,
                [APPEARANCE_OLIVE] = TRAINER_PIC_WALLY,
                [APPEARANCE_BROWN] = TRAINER_PIC_WALLY,
                [APPEARANCE_DARK] = TRAINER_PIC_WALLY,
            }        
        },
