...
const u32 gObjectEventPic_Mercury[] = INCBIN_U32("graphics/object_events/pics/people/npcs/mercury.4bpp.smol");
const u16 gObjectEventPal_Mercury[] = INCBIN_U16("graphics/object_events/palettes/mercury.gbapal");
