...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_MIDDLE_SECOND]    = {SPECIES_SNIVY, 5, GRASS_STARTER, ITEM_NONE, BALL_POKE, NATURE_RANDOM, 0, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}, {MOVE_TACKLE, MOVE_LEER, MOVE_NONE, MOVE_NONE}, 0, TYPE_FIRE, 2},
    [BALL_BOTTOM_FIRST]     = {SPECIES_PIPLUP, 5, WATER_STARTER, ITEM_NONE, BALL_POKE, NATURE_RANDOM, 0, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}, {MOVE_POUND, MOVE_GROWL, MOVE_NONE, MOVE_NONE}, 0, TYPE_GRASS, 2},
    [BALL_BOTTOM_SECOND]    = {SPECIES_FENNEKIN, 5, FIRE_STARTER, ITEM_NONE, BALL_POKE, NATURE_RANDOM, 0, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {32, 32, 32, 32, 32, 32}, {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_NONE, MOVE_NONE}, 0, TYPE_WATER, 2},
};
