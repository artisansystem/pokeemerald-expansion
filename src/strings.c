...
const u8 gText_DexWisemoreTitle[] =_("Wisemore Dex");
const u8 gText_DexSummerspellTitle[] = _("Summerspell Dex");
const u8 gText_DexTitanblazeTitle[] = _("Titanblaze Dex");
const u8 gText_DexAuberonTitle[] = _("Auberon Dex");
const u8 gText_DexWillowbloomTitle[] = _("Willowbloom Dex");
const u8 gText_DexRosesongTitle[] = _("Rosesong Dex");
const u8 gText_DexLockwoodTitle[] = _("Lockwood Dex");
const u8 gText_DexUndergroundTitle[] = _("Underground Dex");
...
const u8 gText_DexWisemoreDescription[] = _("Wisemore Sector's Pokédex");
const u8 gText_DexSummerspellDescription[] = _("Summerspell Sector's Pokédex");
const u8 gText_DexTitanblazeDescription[] = _("Titanblaze Sector's Pokédex");
const u8 gText_DexAuberonDescription[] = _("Auberon Sector's Pokédex");
const u8 gText_DexWillowbloomDescription[] = _("Willowbloom Sector's Pokédex");
const u8 gText_DexRosesongDescription[] = _("Rosesong Sector's Pokédex");
const u8 gText_DexLockwoodDescription[] = _("Lockwood Sector's Pokédex");
const u8 gText_DexNatDescription[] = _("National edition POKéDEX");
const u8 gText_DexUndergroundDescription[] = _("The Underground's Pokédex");
