...
u32 BirchCase_GiveMonParameterized(enum Species species, u8 level, enum Item item, enum PokeBall ball, u8 nature, u8 abilityNum, u8 gender, u8 *evs, u8 *ivs, enum Move *moves, bool8 ggMaxFactor, u8 teraType, bool8 isShinyExpansion)
{
    //
