...
static const u8 sRivalAvatarGfxIds[][GENDER_COUNT][APPEARANCE_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_MACH_BIKE] =
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  =
        ...
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_SURFING] =
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_MAY_SURFING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_MAY_SURFING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_MAY_SURFING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_MAY_SURFING,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_UNDERWATER] = 
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_UNDERWATER,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_UNDERWATER,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_UNDERWATER,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_UNDERWATER,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_UNDERWATER,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_UNDERWATER,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_UNDERWATER,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_UNDERWATER,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = 
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_FISHING]    = 
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_FISHING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_FISHING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_FISHING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_FISHING,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_FISHING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_FISHING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_FISHING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_FISHING,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_WATERING]   =
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_WATERING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_WATERING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_WATERING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_WATERING,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_WATERING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_WATERING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_WATERING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_WATERING,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_VSSEEKER]   = 
    {
        ...
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_FIELD_MOVE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_FIELD_MOVE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_FIELD_MOVE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_FIELD_MOVE,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
...
static const u8 sPlayerAvatarGfxIds[][GENDER_COUNT][APPEARANCE_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = 
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_NORMAL,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_NORMAL,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_NORMAL,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_NORMAL,
        },
        [FEMALE] = 
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_NORMAL,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_NORMAL,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_NORMAL,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_NORMAL, 
        },
        [NONBINARY] = 
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
       ...
       [PLAYER_AVATAR_STATE_MACH_BIKE] =
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_MACH_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_MACH_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_MACH_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_MACH_BIKE,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  =
        ...
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_ACRO_BIKE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_ACRO_BIKE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_ACRO_BIKE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_ACRO_BIKE,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_SURFING] =
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_SURFING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_SURFING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_SURFING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_SURFING,
        },
        [FEMALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_MAY_SURFING,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_MAY_SURFING,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_MAY_SURFING,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_MAY_SURFING,
        },
        [NONBINARY] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_WALLY,
    ...
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = 
    {
        [MALE] =
        {
            [APPEARANCE_LIGHT] = OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
            [APPEARANCE_OLIVE] = OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
            [APPEARANCE_BROWN] = OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
            [APPEARANCE_DARK] = OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
        },
...
u16 GetRivalAvatarGraphicsIdByStateIdAndGender(u8 state, enum Gender gender, enum Appearance appearance)
{
    if (IS_FRLG)
        ...
        return sRivalAvatarGfxIds[state][gender][appearance];
}

u16 GetPlayerAvatarGraphicsIdByStateIdAndGender(u8 state, enum Gender gender, enum Appearance appearance)
{
...
{
    return GetPlayerAvatarGraphicsIdByStateIdAndGender(state, gPlayerAvatar.gender, gPlayerAvatar.appearance);
}
...
void InitPlayerAvatar(s16 x, s16 y, enum Direction direction, enum Gender gender, enum Appearance appearance)
{
    ...
    playerObjEventTemplate.graphicsId = GetPlayerAvatarGraphicsIdByStateIdAndGender(PLAYER_AVATAR_STATE_NORMAL, gender, appearance);
    ...
    gPlayerAvatar.appearance = appearance;
