...
static const u8 *ExpandPlaceholder_Player_Last_Name(void)
{
    return gSaveBlock2Ptr->playerLastName;
}
...
const u8 *GetExpandedPlaceholder(u32 id)
{
    ...
    static const ExpandPlaceholderFunc funcs[] =
    {
        ...
        [PLACEHOLDER_ID_PLAYER_LAST_NAME] = ExpandPlaceholder_Player_Last_Name,
